...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.onClickSubmit = function (data) {
        ...
        this.httpclient.post(this.serverUrl + 'placerecords', { distance: data.distance, lat: this.lat, lng: this.lng, cat: data.fit_cat }).subscribe(function (datas) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        ;
        this.httpclient.post(this.serverUrl + 'placerecords', { distance: "5km", lat: this.lat, lng: this.lng, cat: [] }).subscribe(function (datas) {
            _this.loaderService.display(false);
