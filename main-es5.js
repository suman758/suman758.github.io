...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.onClickSubmit = function (data) {
        ...
        this.httpclient.post(this.serverUrl + 'placerecords', { distance: data.distance, lat: this.lat, lng: this.lng, cat: this.selectedItems.sort(), place_id: '' }).subscribe(function (datas) {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.data.currentMessagesss.subscribe(function (msgg) {
