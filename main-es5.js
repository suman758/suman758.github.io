...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.onClickSubmit = function (data) {
        ...
        var distance = this.nameInput.nativeElement.value;
        console.log(data);
    ...
    HeaderComponent.prototype.handleAddressChange = function (e) {
        ...
        this.loaderService.display(true);
        //this.data.changecathead(this.selectedItems);
        this.httpclient.post(this.serverUrl + 'placerecords', { distance: '20km', lat: this.lat, lng: this.lng, cat: this.selectedItems.sort(), place_id: '' }).subscribe(function (datas) {
            _this.loaderService.display(false);
            //this.closestatus = false;
            console.log(datas);
            _this.result = datas;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.httpclient.get(this.serverUrl + 'category/api-category').subscribe(function (data) {
            ...
            _this.data.currentMessagesss.subscribe(function (msgg) {
                ...
                var distance = _this.nameInput.nativeElement.value;
                console.log(data);
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.clickToChange1 = function (index) {
        ...
        //this.data.changecat(this.selItem);
        //this.data.changecat([]);
        this.httpclient.post(this.serverUrl + 'placerecords', { distance: '20km', lat: this.lat, lng: this.lng, cat: this.selectedItem.sort(), place_id: 0 }).subscribe(function (datas) {
            _this.loaderService.display(false);
            console.log(datas);
            //this.result = datas;
            _this.data.changeMessage(datas);
